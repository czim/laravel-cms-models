...
class TestSimpleThrowsException implements FormFieldStoreStrategyInterface
{
    ...
    {
        throw new \RuntimeException('Failed to retrieve on purpose');
    }
    ...
    {
        throw new \RuntimeException('Failed to store on purpose');
    }
