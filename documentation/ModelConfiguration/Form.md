...
Be warned that validation rule configuration is by its nature complicated and may be confusing.
Please refer to [this document on form validation configuration](FormValidation.md) for exmples and further help 
setting up specific schemes and dealing with edge-cases and exceptions.
